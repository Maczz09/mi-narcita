...
describe('LoginScreen', () => {
  ...
  it('renders login form', () => {
    ...
    expect(screen.getByPlaceholderText('tu@mi-narcita.pe')).toBeInTheDocument();
  ...
  it('submits successfully and navigates', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('tu@mi-narcita.pe'), { target: { value: 'test@test.com' } });
